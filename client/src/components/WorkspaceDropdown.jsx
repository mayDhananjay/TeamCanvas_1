...
function WorkspaceDropdown() {
    ...
    }, [isLoaded, currentWorkspace, setActive]);
            ...
            {isOpen && (
                <div className="absolute z-50 w-64 bg-white dark:bg-zinc-900 border border-gray-200 dark:border-zinc-700 rounded shadow-lg top-full left-0">
                    <div className="p-2">
                        ...
                        {!isLoaded ? (
                            <p className="px-2 py-2 text-sm text-gray-500">Loading workspaces…</p>
                        ) : memberships.length === 0 ? (
                            <p className="px-2 py-2 text-sm text-gray-500">No workspaces found.</p>
